    ...
    public function timezoneDataProvider()
{
    ...
    public function nearestTimezoneDataProvider()
    {
        return array(
            'berlin' => array(52.33, 13.2999999, 'DE', 1, 'Europe/Berlin'),
            'berlin2' => array(52.33, 13.2999999, null, 2, 'Europe/Kaliningrad'),
            'berlin0' => array(52.33, 13.2999999, null, 0, 'Europe/London'),
            'australia8' => array(-27.3269222000,  133.4182154000, null, 8, 'Australia/Perth'),
            'australia' => array(-27.3269222000,  133.4182154000, null, null, 'Australia/Eucla'),
            'australia9' => array(-27.3269222000,  133.4182154000, null, 9, 'Asia/Dili'),
        );
    }

    /**
     * @dataProvider nearestTimezoneDataProvider
     */
    public function testNearestTimezone($latitude, $longitude, $country, $offset, $expectedTimezone)
    {
        $this->assertEquals($expectedTimezone, TimezoneHelper::getNearestTimezone($latitude, $longitude, $country, $offset));
    }

    public function testNearestTimezoneWithInvalidData()
    {
        $this->expectException(\RuntimeException::class);
        $this->expectExceptionMessage('Timezone for lat: 52.33 lon: 13.2999999 country: DE with offset: 2 could not be located.');
        TimezoneHelper::getNearestTimezone(52.33, 13.2999999, 'DE', 2);
    }
}
